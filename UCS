...
void Graph::UCS(int startNode){
	cout<<"\nFinding Shortest Path starts . . . \n";
	...
	while(!this->isAllKeyTrue()){
		...
		cout<<"Shortest Path: "<<this->parent[minDistanceNode]<<"->"
			<<minDistanceNode<<", UCS is: "<<distance[minDistanceNode]<<"\n";
...
*/
    Graph g(7);
	g.addEdgeDirectedWeight(0, 1, 5);
	g.addEdgeDirectedWeight(0, 3, 3);
	g.addEdgeDirectedWeight(1, 2, 1);
	g.addEdgeDirectedWeight(2, 4, 6);
	g.addEdgeDirectedWeight(4, 1, 4);
	g.addEdgeDirectedWeight(3, 4, 2);
	g.addEdgeDirectedWeight(2, 6, 8);
	g.addEdgeDirectedWeight(6, 4, 4);
	g.addEdgeDirectedWeight(3, 5, 2);
	g.addEdgeDirectedWeight(5, 6, 3);
